    ...
    function buildMarkInterpretation(m) {
      ...
      if (m.kind === 'line' && passesTenchu) {
        ...
        if (isBright) {
          ...
          summaryParts.push('天中に線が達していること自体が、伝統的には大きな意味を持つ相とされます(上級編での確認: 色に関わらず、天中まで登る線は自分の力を超えた大事・法的な事態と結びつきやすいとされます)。加えて、明るい色で天中から下る場合はご先祖からの加護、暗い色で天中へ向かう場合は自分の力ではどうにもならない大事、という色による読み分けもあります。今回は色の判定がはっきりしないため、どちらの意味合いが強いかまでは判断できません。');
        }
